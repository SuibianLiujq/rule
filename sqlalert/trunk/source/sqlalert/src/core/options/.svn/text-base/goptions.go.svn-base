/*
package options implements a flexible parser for command line options.
...
by the tags in a (possibly anonymous) struct.
    ...
    var options struct {
    	Name string `options:"-n, --name"`
    	Force bool `options:"-f, --force"`
    	Verbosity int `options:"-v, --verbose"`
    }
...
has to have a "options" tag. The contains the short and long flag names for this
...
options also has support for verbs. Each verb accepts its own set of flags which
